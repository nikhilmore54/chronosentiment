...
async function runOptimizer(scenarioId, generationLimit, seed) {
  ...
  const res = await fetch(`${API_BASE}/api/schedule`, {
    ...
    body: JSON.stringify({ workers, shifts, rng_seed: seed, generation_limit: generationLimit, scenario: { planning_horizon_hours: horizonHours, max_hours_per_worker: maxHoursPerWorker, minimum_rest_hours: 10 } }),
  });
