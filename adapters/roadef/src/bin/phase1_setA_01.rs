...
fn main() {
    ...
    let net = load_network("adapters/roadef/repo/challenge-roadef-2026-main/setA/setA-01-net.json")
        .unwrap();
    let tm =
        load_traffic_matrix("adapters/roadef/repo/challenge-roadef-2026-main/setA/setA-01-tm.json")
            .unwrap();
    let scenario =
        load_scenario("adapters/roadef/repo/challenge-roadef-2026-main/setA/setA-01-scenario.json")
            .unwrap();
