# PIPELINE A/B Report: Load-Aware Greedy Constructor

**Campaign:** pipeline_ab_v2.3  
**Timestamp:** 2026-08-20T05:33:02.834851+00:00  
...
| Metric | Arm A (Random / CB-000) | Arm B (Greedy / PIPELINE) | Delta |
|--------|------------------------|------------------------|-------|
...
PIPELINE improves the official ROADEF objective on ≥ 2/3 of instances without runtime regression. Recommend integrating GreedyLoadAware as the default construction mode for the RC integration branch.
