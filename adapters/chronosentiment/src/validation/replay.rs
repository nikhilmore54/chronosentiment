...
use crate::validation::context::{
    InstrumentEvaluationContext, MarketEvaluationContext as EvaluationContext,
};
...
impl<'a> ReplayEngine<'a> {
    ...
    pub async fn generate_context(
        ...
        inst_contexts.insert(
            request.target_instrument_id,
            InstrumentEvaluationContext {
