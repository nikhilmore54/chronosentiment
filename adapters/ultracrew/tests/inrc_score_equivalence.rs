...
fn test_inrc_score_equivalence() {
    ...
    println!("---------------------|---------|-----------|-------");
    println!("Days Off             | {:<7} | {:<9} | {}", best.soft_report.day_off_penalty, val_days_off, best.soft_report.day_off_penalty == val_days_off);
    println!("Preferences          | {:<7} | {:<9} | {}", best.soft_report.preferences_penalty, val_preferences, best.soft_report.preferences_penalty == val_preferences);
    println!("Complete Weekends    | {:<7} | {:<9} | {}", best.soft_report.weekend_penalty, val_weekends, best.soft_report.weekend_penalty == val_weekends);
    println!("Consecutive Work     | {:<7} | {:<9} | {}", best.soft_report.work_streak_penalty, val_consecutive, best.soft_report.work_streak_penalty == val_consecutive);
    println!("Optimal Coverage     | {:<7} | {:<9} | {}", best.soft_report.optimal_coverage_penalty, val_optimal, best.soft_report.optimal_coverage_penalty == val_optimal);

    assert_eq!(best.soft_report.day_off_penalty, val_days_off, "Days off mismatch!");
