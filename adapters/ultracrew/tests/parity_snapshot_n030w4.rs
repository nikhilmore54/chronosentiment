...
fn test_parity_snapshot() {
    ...
    assert_eq!(evaluation.soft_report.day_off_penalty, expected_days_off, "Regression in Days Off!");
    assert_eq!(evaluation.soft_report.preferences_penalty, expected_preferences, "Regression in Preferences!");
    assert_eq!(evaluation.soft_report.weekend_penalty, expected_weekends, "Regression in Weekends!");
