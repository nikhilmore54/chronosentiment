...
fn main() {
    ...
    let evaluation = optimizer.evaluate(
        &genome,
    ...
    println!(
        "Consecutive work penalty: {}",
        evaluation.soft_report.work_streak_penalty
    );
    println!(
        "Preferences penalty: {}",
        evaluation.soft_report.preferences_penalty
    );
    println!(
        "Complete weekends penalty: {}",
        evaluation.soft_report.weekend_penalty
    );
    println!(
        "Optimal coverage penalty: {}",
        evaluation.soft_report.optimal_coverage_penalty
    );
}
