...
fn main() {
    ...
    let mut file = std::fs::File::create("ultracrew_repair_atlas.csv").unwrap();
    writeln!(file, "transition_level,raw_magnitude,residual_magnitude,repair_delta,s1_fitness,s2_fitness,s1_returned_to_same_region,returned_to_same_region,retained_elite").unwrap();
