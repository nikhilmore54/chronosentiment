use cvrp::{CvrpInstance, CvrpCandidate, CvrpGenomeFactory, moga_impl::{CvrpEvaluator, CvrpMutator, CvrpCrossoverVariant, CvrpCrossover}};
...
fn main() {
    ...
    println!("Running exhaustive deterministic Local Search (2-opt, Swap, Relocate) on incumbent...");
    ...
    println!("Improvement: {:.2} (Took {:?})", best_dist - after_dist, start.elapsed());
}
