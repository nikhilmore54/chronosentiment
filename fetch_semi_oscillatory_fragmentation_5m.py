...
# 09:30 EDT = 13:30 UTC
target_ts = int(datetime(2026, 5, 19, 13, 30, tzinfo=timezone.utc).timestamp() * 1000)
end_ts = target_ts + (300 * 60 * 1000) # 300 minutes (60 ticks)

for sym in ['NVDA', 'AMD']:
    output_dir = f"core/chronology/historical/2026_{sym.lower()}_sync_oscillatory_fragmentation_5m"
