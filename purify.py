...
REPLACEMENTS = [
    (r"\bStrategyEvaluation\b", "CandidateEvaluation"),
    (r"\bRankStats\b", "EvaluationMetrics"),
    (r"\bAlphaConsensus\b", "ConsensusMetric"),
    (r"\bMarketRegime\b", "ScenarioContext"),
    (r"\bDirectionArchetype\b", "BehavioralArchetype"),
    (r"\bOrderIntent\b", "ExecutionDirective"),
    (r"\bTradeRecommendation\b", "ExecutionProposal"),
]
