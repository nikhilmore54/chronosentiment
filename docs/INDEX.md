...
| OBS-000 — Temporal Integrity Test Suite | **NEXT MILESTONE** — prove recorder cannot leak future information; test LONG/SHORT target/risk detection, horizon expiry, simultaneous boundary events, missing prices, weekends/holidays, incomplete windows, duplicate events, replay/idempotency; must pass before automatic observation collection begins | 2026-08-19 |
