...
| OBS-001 — Automatic Observation Engine | **PLANNED** — direction-aware MFE/MAE (LONG: max(price-ref)/ref; SHORT: max(ref-price)/ref); target_reached, risk_reached, first_exit, sessions_to_outcome; append-only, never modifies T0 | 2026-08-19 |
