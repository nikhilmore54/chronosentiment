# Claim 019: Extraction Window Stability (Replay Stability Retest)
...
The empirical correspondence pairs documented within the bounded composite 5m semiconductor family demonstrate local window stability under the tested parameters. The geometry is sensitive to internal structural perturbations (like volume collapses or reversals) but remained stable against the minor temporal offsets of the extraction boundary tested here. This provides a bounded validation of the 60-tick extraction methodology.
