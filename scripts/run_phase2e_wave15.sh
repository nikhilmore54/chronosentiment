...
echo "Starting Phase 2E-M Matrix (Replay Boundary Mapping: Stability Retests)..."
cd core
...
for UNIVERSE in "${UNIVERSES[@]}"; do
    ...
    TIER1_OUT_A="artifacts/phase2e_m/${UNIVERSE}/tier1_5m/${COGNITION_A}"
    ...
    TIER1_OUT_B="artifacts/phase2e_m/${UNIVERSE}/tier1_5m/${COGNITION_B}"
...
echo "Phase 2E-M Matrix complete."
