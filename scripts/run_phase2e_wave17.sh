...
echo "Starting Phase 2E-O Matrix (Replay Boundary Mapping: Preservation Stability Retests)..."
cd core
...
UNIVERSES=(
    "2026_aapl_downward_drop_shift_neg_10m"
    "2026_aapl_downward_drop_shift_pos_10m"
    "2026_aapl_downward_drop_shift_pos_20m"
)
...
for UNIVERSE in "${UNIVERSES[@]}"; do
    ...
    TIER1_OUT_A="artifacts/phase2e_o/${UNIVERSE}/tier1_5m/${COGNITION_A}"
    ...
    TIER1_OUT_B="artifacts/phase2e_o/${UNIVERSE}/tier1_5m/${COGNITION_B}"
...
echo "Phase 2E-O Matrix complete."
