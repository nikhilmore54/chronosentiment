...
echo "Starting Phase 2E-C4 Matrix (Contradiction Pressure: Downward Drop without Collapse)..."
cd core
...
for UNIVERSE in "${UNIVERSES[@]}"; do
    ...
    TIER1_OUT_A="artifacts/phase2e_c4/${UNIVERSE}/tier1_5m/${COGNITION_A}"
    ...
    TIER1_OUT_B="artifacts/phase2e_c4/${UNIVERSE}/tier1_5m/${COGNITION_B}"
...
echo "Phase 2E-C4 Matrix complete."
