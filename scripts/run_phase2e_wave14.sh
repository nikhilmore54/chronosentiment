...
echo "Starting Phase 2E-L Matrix (Replay Boundary Mapping: Semi Midday Vacuum)..."
cd core
...
UNIVERSES=(
    "2026_nvda_sync_vacuum"
    "2026_amd_sync_vacuum"
)
...
for UNIVERSE in "${UNIVERSES[@]}"; do
    ...
    TIER1_OUT_A="artifacts/phase2e_l/${UNIVERSE}/tier1_5m/${COGNITION_A}"
    ...
    TIER1_OUT_B="artifacts/phase2e_l/${UNIVERSE}/tier1_5m/${COGNITION_B}"
...
echo "Phase 2E-L Matrix complete."
