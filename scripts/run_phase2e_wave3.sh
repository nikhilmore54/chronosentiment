...
echo "Starting Phase 2E-C Matrix (Macro Shock Ecology Transfer)..."
cd core
...
for UNIVERSE in "${UNIVERSES[@]}"; do
    ...
    TIER1_OUT_A="artifacts/phase2e_c/${UNIVERSE}/tier1_1m/${COGNITION_A}"
    ...
    TIER1_OUT_B="artifacts/phase2e_c/${UNIVERSE}/tier1_1m/${COGNITION_B}"
...
echo "Phase 2E-C Matrix complete."
