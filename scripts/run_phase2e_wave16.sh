...
echo "Starting Phase 2E-N Matrix (Replay Boundary Mapping: Vacuum Stability Retests)..."
cd core
...
UNIVERSES=(
    "2026_nvda_sync_vacuum_shift_neg_10m"
    "2026_amd_sync_vacuum_shift_neg_10m"
    "2026_nvda_sync_vacuum_shift_pos_10m"
    "2026_amd_sync_vacuum_shift_pos_10m"
    "2026_nvda_sync_vacuum_shift_pos_20m"
    "2026_amd_sync_vacuum_shift_pos_20m"
)
...
for UNIVERSE in "${UNIVERSES[@]}"; do
    ...
    TIER1_OUT_A="artifacts/phase2e_n/${UNIVERSE}/tier1_5m/${COGNITION_A}"
    ...
    TIER1_OUT_B="artifacts/phase2e_n/${UNIVERSE}/tier1_5m/${COGNITION_B}"
...
echo "Phase 2E-N Matrix complete."
