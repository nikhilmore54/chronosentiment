...
echo "Starting Phase 2E-Q Matrix (Replay Boundary Mapping: Oscillatory Fragmentation)..."
cd core
...
UNIVERSES=(
    "2026_nvda_sync_oscillatory_fragmentation"
    "2026_amd_sync_oscillatory_fragmentation"
)
...
for UNIVERSE in "${UNIVERSES[@]}"; do
    ...
    TIER1_OUT_A="artifacts/phase2e_q/${UNIVERSE}/tier1_5m/${COGNITION_A}"
    ...
    TIER1_OUT_B="artifacts/phase2e_q/${UNIVERSE}/tier1_5m/${COGNITION_B}"
...
echo "Phase 2E-Q Matrix complete."
