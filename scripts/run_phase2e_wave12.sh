...
echo "Starting Phase 2E-J Matrix (Replay Boundary Mapping: Semi Gap-and-Fade)..."
cd core
...
UNIVERSES=(
    "2026_nvda_sync_gap_fade"
    "2026_amd_sync_gap_fade"
)
...
for UNIVERSE in "${UNIVERSES[@]}"; do
    ...
    TIER1_OUT_A="artifacts/phase2e_j/${UNIVERSE}/tier1_5m/${COGNITION_A}"
    ...
    TIER1_OUT_B="artifacts/phase2e_j/${UNIVERSE}/tier1_5m/${COGNITION_B}"
...
echo "Phase 2E-J Matrix complete."
