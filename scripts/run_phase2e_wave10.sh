...
echo "Starting Phase 2E-H Matrix (Replay Boundary Mapping: Semi Ladder)..."
cd core
...
UNIVERSES=(
    "2026_nvda_sync_drop_weak"
    "2026_amd_sync_drop_weak"
    "2026_nvda_sync_drop_moderate"
    "2026_amd_sync_drop_moderate"
)
...
for UNIVERSE in "${UNIVERSES[@]}"; do
    ...
    TIER1_OUT_A="artifacts/phase2e_h/${UNIVERSE}/tier1_5m/${COGNITION_A}"
    ...
    TIER1_OUT_B="artifacts/phase2e_h/${UNIVERSE}/tier1_5m/${COGNITION_B}"
...
echo "Phase 2E-H Matrix complete."
