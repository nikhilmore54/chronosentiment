...
echo "Starting Phase 2E-C3 Matrix (Contradiction Pressure: Upward Squeeze)..."
cd core
...
for UNIVERSE in "${UNIVERSES[@]}"; do
    ...
    TIER1_OUT_A="artifacts/phase2e_c3/${UNIVERSE}/tier1_5m/${COGNITION_A}"
    ...
    TIER1_OUT_B="artifacts/phase2e_c3/${UNIVERSE}/tier1_5m/${COGNITION_B}"
...
echo "Phase 2E-C3 Matrix complete."
