...
echo "Starting Phase 2E-G Matrix (Controlled Similarity Pairing: Correspondence)..."
cd core
...
for UNIVERSE in "${UNIVERSES[@]}"; do
    ...
    TIER1_OUT_A="artifacts/phase2e_g/${UNIVERSE}/tier1_5m/${COGNITION_A}"
    ...
    TIER1_OUT_B="artifacts/phase2e_g/${UNIVERSE}/tier1_5m/${COGNITION_B}"
...
echo "Phase 2E-G Matrix complete."
