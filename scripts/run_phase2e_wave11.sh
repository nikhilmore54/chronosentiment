...
echo "Starting Phase 2E-I Matrix (Replay Boundary Mapping: Semi Rally Ladder)..."
cd core
...
UNIVERSES=(
    "2026_nvda_sync_rally_weak"
    "2026_amd_sync_rally_weak"
    "2026_nvda_sync_rally_moderate"
    "2026_amd_sync_rally_moderate"
)
...
for UNIVERSE in "${UNIVERSES[@]}"; do
    ...
    TIER1_OUT_A="artifacts/phase2e_i/${UNIVERSE}/tier1_5m/${COGNITION_A}"
    ...
    TIER1_OUT_B="artifacts/phase2e_i/${UNIVERSE}/tier1_5m/${COGNITION_B}"
...
echo "Phase 2E-I Matrix complete."
