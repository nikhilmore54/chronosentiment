...
echo "Starting Phase 2E-K Matrix (Replay Boundary Mapping: Semi Failed Continuation)..."
cd core
...
for UNIVERSE in "${UNIVERSES[@]}"; do
    ...
    TIER1_OUT_A="artifacts/phase2e_k/${UNIVERSE}/tier1_5m/${COGNITION_A}"
    ...
    TIER1_OUT_B="artifacts/phase2e_k/${UNIVERSE}/tier1_5m/${COGNITION_B}"
...
echo "Phase 2E-K Matrix complete."
