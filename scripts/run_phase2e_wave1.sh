...
echo "Starting Phase 2E-A Matrix (Equities Bounded Session Transfer)..."
cd core
...
UNIVERSES=(
    "2026_aapl_overnight_gap"
    "2026_reliance_overnight_gap"
)
...
for UNIVERSE in "${UNIVERSES[@]}"; do
    ...
    KLINE_FILE="chronology/historical/${UNIVERSE}_1m/*.jsonl"
    ...
    TIER1_OUT_A="artifacts/phase2e/${UNIVERSE}/tier1_1m/${COGNITION_A}"
    ...
    TIER1_OUT_B="artifacts/phase2e/${UNIVERSE}/tier1_1m/${COGNITION_B}"
