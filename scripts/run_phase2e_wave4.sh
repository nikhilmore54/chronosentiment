...
echo "Starting Phase 2E-C1 Matrix (Ontology-Bounded Composite Rupture Replay)..."
cd core
...
for UNIVERSE in "${UNIVERSES[@]}"; do
    ...
    TIER1_OUT_A="artifacts/phase2e_c1/${UNIVERSE}/tier1_5m/${COGNITION_A}"
    ...
    TIER1_OUT_B="artifacts/phase2e_c1/${UNIVERSE}/tier1_5m/${COGNITION_B}"
...
echo "Phase 2E-C1 Matrix complete."
