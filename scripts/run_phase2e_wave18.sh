...
echo "Starting Phase 2E-P Matrix (Replay Boundary Mapping: Open-Drive Absorption)..."
cd core
...
for UNIVERSE in "${UNIVERSES[@]}"; do
    ...
    TIER1_OUT_A="artifacts/phase2e_p/${UNIVERSE}/tier1_5m/${COGNITION_A}"
    ...
    TIER1_OUT_B="artifacts/phase2e_p/${UNIVERSE}/tier1_5m/${COGNITION_B}"
...
echo "Phase 2E-P Matrix complete."
