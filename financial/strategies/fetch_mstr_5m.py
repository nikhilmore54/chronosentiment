...
output_dir = "core/chronology/historical/2026_mstr_upward_squeeze_5m"
os.makedirs(output_dir, exist_ok=True)
df = yf.download('MSTR', period='60d', interval='5m')
target_dt = datetime(2026, 4, 17, 13, 35, tzinfo=timezone.utc)
target_ts = int(target_dt.timestamp() * 1000)
end_ts = target_ts + (300 * 60 * 1000) # 5 hours = 60 ticks
...
out_path = f"{output_dir}/mstr_{target_ts}.jsonl"
