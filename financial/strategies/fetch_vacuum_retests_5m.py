...
# Base event: 2026-05-20 13:30:00+00:00
base_dt = datetime(2026, 5, 20, 13, 30, tzinfo=timezone.utc)
...
for shift_name, target_ts in perturbations.items():
    ...
    for sym in ['NVDA', 'AMD']:
        output_dir = f"core/chronology/historical/2026_{sym.lower()}_sync_vacuum_{shift_name}_5m"
