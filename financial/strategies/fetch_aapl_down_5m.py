...
output_dir = "core/chronology/historical/2026_aapl_downward_drop_5m"
os.makedirs(output_dir, exist_ok=True)
df = yf.download('AAPL', period='60d', interval='5m')
target_dt = datetime(2026, 4, 7, 13, 30, tzinfo=timezone.utc)
...
out_path = f"{output_dir}/aapl_{target_ts}.jsonl"
