...
output_dir = "core/chronology/historical/2026_nvda_open_cascade_5m"
os.makedirs(output_dir, exist_ok=True)
df = yf.download('NVDA', period='60d', interval='5m')
target_dt = datetime(2026, 4, 30, 13, 30, tzinfo=timezone.utc)
...
out_path = f"{output_dir}/nvda_{target_ts}.jsonl"
