...
fn run_search(
    ...
    println!("    SA Stats -> Start: {:.2} | Peak Worsening: {:.2} | Best: {:.2}", start_dist, max_dist_seen, best_dist);
    println!("    SA Moves -> Acc: {} | Rej: {} | Imp: {} | Wors: {}", accepted_moves, rejected_moves, improving_moves, worsening_moves);
